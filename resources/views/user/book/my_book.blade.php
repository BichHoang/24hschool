                                        ...
                                        <div class="row" style="height: 250px;">
                                            <div class="col-lg-7 col-12">
                                                <img src="{{url('image_book/'. $value->previous_image)}}"
                                                     alt="Ảnh bìa cuốn sách" style="width: 100%; height: 200px;">
                                            </div>
                                            <div id="info" class="col-lg-5 col-12">
                                                <ul>
                                                    <li style="padding-top: 5px;">
                                                        <button onclick="location.href='{{url('user/ebook-cua-toi/'. $value->id)}}'"
                                                                id="buybt">
                                                            <i class="fa fa-arrow-circle-right"></i>Xem sách
                                                        </button>
                                                    </li>
                                                </ul>
                                            </div>
