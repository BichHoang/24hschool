        ...
        @if(count($data) <= 0)
            <div style="text-align: center; padding: 20px;">
                <div style="border: #c4e3f3 1px">
                    <h3 style="padding-bottom: 15px;">Giỏ tài liệu của bạn đang trống!</h3>
                    ...
                    <div class="col-12" id="boxCart">
                        <div style="margin: 15px;">
                            ...
                            @foreach($data as $document)
                                <div class="row" id="contentCart">
                                    <div class="col-lg-2 col-12">
                                        <img src="{{url('image_document/'. $document->image)}}" width="100%">
                                    </div>
                                    <div class="col-lg-3 col-12" id="nameProduct">{{$document->name}}</div>
                                    @if($document->type_document == 0)
                                        <div class="col-lg-2 col-12">Miễn phí</div>
                                    @else
                                        <div class="col-lg-2 col-12">{{$document->price}}</div>
                                    @endif
                                    <div class="col-lg-2 col-12">
                                        {{$document->number}}
                                    </div>
                                    ...
                                    @else
                                        <div class="col-lg-2 col-12">{{$document->sale}}</div>
                                    @endif
                                    <div class="col-lg-1 col-12" style="text-align: center">
                                        <a class="delete_a_document" href="{{url('user/document/delete_document-'. $document->id)}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <button id="btAddProduct" onclick="location.href='{{url('user/document/all')}}'">
                                        Thêm sản phẩm
                                    </button>
                                </div>

                                <div class="col-sm-2">
                                    <a class="delete_all_document" href="{{url('user/document/delete_all_document')}}">
                                        <button id="btDeleteAllDocument">
                                            Xóa tất cả giỏ
                                        </button>
                                    </a>
                                </div>
                            ...
                            <div class="col-lg-8">
                                <form action=""
                                    ...
                                    <div style="text-align: left; font-size: 18px;">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="payment" value="3">Thanh toán tại cửa hàng
                                        </label>
                                    </div>
                                    <div style="text-align: left; font-size: 18px;">
...
@section('script')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('a.delete_a_document').confirm({
                icon: 'fa fa-bullhorn',
                content: "Xóa tài liệu này",
                title: "Thông báo",
                type: 'red',
                typeAnimated: true,
                draggable: false,
            ...
            $('a.delete_all_document').confirm({
                icon: 'fa fa-bullhorn',
                content: "Xóa tất cả tài liệu trong giỏ",
                title: "Thông báo",
                type: 'red',
                typeAnimated: true,
                draggable: false,
