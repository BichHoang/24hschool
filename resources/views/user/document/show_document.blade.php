                ...
                <div class="col-lg-3 col-12">
                    <div class="learnedu-sidebar left">
                        ...
                        <div class="single-widget categories">
                            ...
                            <ul>
                                @for($i=0;$i<5;$i++)
                                    <li><a href="#"><i class="fa fa-book"></i>Tài liệu Toán</a></li>
                                @endfor
                            </ul>
                        </div>
                        <!--/ End Categories -->
                            ...
                            <div class="sort-box-holder">
                                <div class="btn-group pull-left sort-box">
                                    ...
                                    <ul class="sort-list">
                                        ...
                                        <li class="">
                                            <div class="search">
                                                <form action="{{url('user/document/search-%20')}}" method="post">
                                        ...
                                        <div class="row" style="height: 250px;">
                                            <div class="col-lg-7 col-12">
                                                <img src="{{url('image_document/'. $value->image)}}"
                                                     alt="Ảnh bìa tài liệu" width="100%" height="100%">
                                            </div>
                                            <div id="info" class="col-lg-5 col-12">
                                                <ul>
                                                    ...
                                                    <li style="color: #7a43b6">
                                                        <a href="{{url('user/transaction/document/buy_document/'. $value->id)}}"
                                                           title="Mua tài liệu mềm">
                                                            <i class="fa fa-cart-plus">Mua tài liệu</i>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li style="padding-top: 5px;">
                                                        <button onclick="location.href='{{url('user/document/detail/'. $value->id)}}'"
                                                                id="buybt">
