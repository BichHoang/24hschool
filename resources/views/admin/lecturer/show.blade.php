                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Danh sách giáo viên</strong>
                        </div>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        @if(isset($search_old))
                                            <input type="text" name="txt_search" class="col-lg-6"
                                                   placeholder="Tìm kiếm giáo viên" value="{{$search_old}}" required>
                                        @else
                                            <input type="text" name="txt_search" class="col-lg-6"
                                                   placeholder="Tìm kiếm giáo viên" required>
                                        @endif
                                        ...
                                        <span style="color: #000000; font-weight:bold;">{{$start+1}}- {{$start+count($data)}}
