...
@section('content')
    <div class="animated fadeIn">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header"><strong>Thêm mới cộng tác viên</strong>
                    </div>
                        ...
                        <div class="card-body card-block">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" required
                                       placeholder="Email của cộng tác viên" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="txt_full_name" class=" form-control-label">
                                    Họ và tên<b style="color: #ff2e44; font-size: 14px;">(*)</b>
                                </label>
                                <input type="text" name="full_name" id="txt_full_name"
                                       placeholder="Họ tên của cộng tác viên" class="form-control">
                            </div>
                            <div class="form-group">
                        ...
                        <div>
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" id="save">
                                    <i class="fa fa-dot-circle-o"></i> Tạo cộng tác viên
                                </button>
