                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" style="width: 100px;">Người gửi</th>
                                    ...
                                    @foreach($data as $index => $row)
                                        <tr>
                                            ...
                                            <td>
                                                {{date('H:i:s d/m/Y', strtotime($row->date_send_request_approve))}}
                                            </td>
                                            <td>{{$row->user_name}}</td>
                                            <td>
                                                <a href="{{url('lecturer/exam/exam_waiting_approve/detail='. $row->id)}}">
