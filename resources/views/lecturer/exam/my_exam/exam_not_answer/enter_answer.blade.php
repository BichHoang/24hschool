    ...
    @if(isset($exam) && count($exam) > 0)
        ...
        <div class="panel-heading-row">
            <div class="col-lg-6">
                ...
                <iframe width="100%" height="600px" style="margin-left: 0;"
                        src="{{url('lecturer/file_exam='.$file_name)}}?#scrollbar=1&toolbar=1&navpanes=1&statusbar=1&view=fitH,100"
                        id="pdf_content">
                </iframe>
            </div>
            <div class="col-lg-6">
        ...
        <div class="panel-heading-row">
            <form enctype="multipart/form-data" method="post" action="" id="my_form">
                ...
                <div class="panel-heading row" style="padding-top: 2em;margin-left: 370px">
                    <div class="col-lg-3">
