                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Danh sách đề thi của tôi đã có đáp án</strong>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($data as $index => $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="" class="save_exam_to_approved" id="{{$row->id}}">
                                                    <button style="background-color: #34ce57; color: #000000;">
                                                        Duyệt
                                                    </button>
                                                </a>
                                                <a href="{{url('lecturer/exam/my_exam/detail_exam='.$row->id)}}">
                                                    <button style="background-color: #00acc1; color: #000000">
                                                        Xem chi tiết
                                                    </button>
                                                </a>
                                                <a href="{{url('lecturer/exam/my_exam/update='. $row->id)}}">
                                                    <button style="background-color: #27ae60; color: #000000">
                                                        Chỉnh sửa
                                                    </button>
                                                </a>
                                                <a class="delete_exam"
                                                   href="{{url('lecturer/exam/my_exam/delete='. $row->id)}}">
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('a.save_exam_to_approved').confirm({
                columnClass: 'col-md-6',
                icon: 'fa fa-bullhorn',
                title: "Lưu ý",
                content: "Duyệt đề thi",
                type: 'blue',
                typeAnimated: true,
                draggable: false,
                buttons: {
                    duyet_len_web: {
                        ...
                        action: function () {
                            ...
                            window.location.replace('save_exam_to_web=' + id);
                        }
                    },
                    duyet_vao_kho: {
                        text: 'Đưa đề vào kho đề',
                        btnClass: 'btn-blue',
                        action: function () {
                            id = this.$target.attr('id');
                            window.location.replace('save_exam_to_repository=' + id);
                        }
                    },
                    cancel: function () {
