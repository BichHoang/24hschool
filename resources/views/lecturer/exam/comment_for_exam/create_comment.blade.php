...
@section('content')
    ...
    @if(isset($exam) && count($exam) > 0)
        ...
        <form action="{{url('lecturer/exam/exam_waiting_approve/send_modify='.$exam->id)}}" method="post">
            <input type="hidden" name="_token" value="<?= csrf_token() ?>">
            <div class="row">
                <div class="col-lg-2">Viết nhận xét</div>
                <div class="col-lg-6">
                    <textarea name="ta_comment" rows="4" cols="60"></textarea>
                </div>
            </div>
