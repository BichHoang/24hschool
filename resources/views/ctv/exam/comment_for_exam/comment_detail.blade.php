...
@section('content')
    ...
    @if(isset($exam) && count($exam) > 0 && isset($comment))
        <object width="670px" height="600px" type='application/pdf' style="margin-left: 0;"
                data="{{url('ctv/file_exam='.$exam->name_briefly)}}?#zoom=80&scrollbar=1&toolbar=1&navpanes=1"
                id="pdf_content">
            <h3>Rất tiếc !<br>
        ...
        <div class="row" style="padding-top: 1em;">
            ...
            <div class="col-lg-2">
                <input type="button" class="btn btn-success"
                       onclick="location.href = '{{url("ctv/exam/update=".$exam->id)}}'"
                       value="Chỉnh sửa đề thi">
            </div>
            <div class="col-lg-3">
                <input type="button" class="btn btn-primary"
                       onclick="location.href = '{{url("ctv/exam/need_modify/comment/list=".$exam->id)}}'"
                       value="Trở về">
            </div>
        </div>
    @else
