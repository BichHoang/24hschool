                                ...
                                <table class="table">
                                    ...
                                    @foreach($data as $index => $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('ctv/exam/need_modify/request_approve_again='. $row->id)}}"
                                                   class="send_approve_again">
                                                    <button class="btn btn-success">
                                                        Gửi duyệt lại
                                                    </button>
                                                </a>
                                                <a href="{{url('ctv/exam/need_modify/comment/list='.$row->id)}}">
...
@section('script')
    <script type="text/javascript">
        var id = null;
        $('a.send_approve_again').confirm({
            columnClass: 'col-md-6',
            icon: 'fa fa-bullhorn',
            title: "Lưu ý",
            content: "Gửi yêu cầu duyệt đề thi lại",
            type: 'blue',
            typeAnimated: true,
            draggable: false,
            buttons: {
