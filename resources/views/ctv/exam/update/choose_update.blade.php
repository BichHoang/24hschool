...
@section('content')
    ...
    @if(isset($exam) && !is_null($exam))
        ...
        <div class="panel-heading row" style="padding-top: 1em">
            ...
            <div class="col-lg-6">
                <a href="{{url('ctv/exam/update_exam_file=' . $exam->id)}}">
        ...
        <div class="panel-heading row" style="padding-top: 1em">
            ...
            <div class="col-lg-6">
                <a href="{{url('ctv/exam/update_explain_file='. $exam->id)}}">
        ...
        <div class="panel-heading row" style="padding-top: 1em">
            ...
            <div class="col-lg-6">
                <a href="{{url('ctv/exam/update_exam_info='. $exam->id)}}">
        ...
        @if($exam->status == 5 || $exam->status == 4 || $exam->status == 6)
            <div class="panel-heading row" style="padding-top: 1em">
                <div class="col-lg-2"></div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-6">
                    <a href="{{url('ctv/exam/update_list_answer='. $exam->id)}}">
        ...
        <div class="panel-heading row" style="padding-top: 1em">
            ...
            <div class="col-lg-6">
                @if($exam->status == 3) {{--de thi chua co dap an --}}
                    <a href="{{url('ctv/exam/not_answer/list='. $exam->name)}}">
                        <button class="btn btn-success" style="background-color: #15D588">
                            Chỉnh sửa xong
                        </button>
                    </a>
                @elseif($exam->status == 4){{--de thi can chinh sua--}}
                    <a href="{{url('ctv/exam/need_modify/list='. $exam->name)}}">
                        <button class="btn btn-success" style="background-color: #15D588">
                            Chỉnh sửa xong
                        </button>
                    </a>
                @elseif($exam->status == 5){{--de thi co dap an --}}
                    <a href="{{url('ctv/exam/have_answer/list='. $exam->name)}}">
                        <button class="btn btn-success" style="background-color: #15D588">
                            Chỉnh sửa xong
                        </button>
                    </a>
                @elseif($exam->status == 6){{--de thi da gui duyet--}}
                    <a href="{{url('ctv/exam/waiting_approve/list='. $exam->name)}}">
                        <button class="btn btn-success" style="background-color: #15D588">
                            Chỉnh sửa xong
                        </button>
                    </a>
